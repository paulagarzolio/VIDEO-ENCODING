...
def EX1P2():
    ...
    N=int(input("Length you want your video to have [seconds]: ")) #here the user inputs the length of the video (how much they want to conserve from the original video
    string= "00:00:"+str(N)
    ...
    print("Video saved as: ", 'output.mp4') #this will show the user the name of the output file
